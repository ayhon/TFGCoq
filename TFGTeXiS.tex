...
% \include{Chapters/3_CoqProofAssistant}
% \end{otherlanguage}
% \end{document}
...
\include{Chapters/3_CoqProofAssistant}
\include{Chapters/4_Definitions}
\include{Chapters/5_ImpCheckerThroughTransitiveClosure}
% \include{Capitulos/1_Introduction}
% \include{Capitulos/2_StateOfTheArt}
% \include{Capitulos/3_DescriptionOfTheProject}
%\include{Capitulos/Capitulo4}
%\include{Capitulos/Capitulo5}
\include{Chapters/9_ConclusionsAndFutureWork}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Si el TFG se escribe en inglés, comentar las siguientes líneas 
% porque no es necesario incluir nuevamente las Conclusiones en inglés
\end{otherlanguage}
\include{Capitulos/1b_Introduccion}
\include{Capitulos/4b_ConclusionesYTrabajoFuturo}
\begin{otherlanguage}{english}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
