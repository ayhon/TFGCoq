...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tituloPortada{%
Arithmetic constraints resolver verified in Coq for the certification of EVM optimizations.
}
...
\textbf{Resolutor de restricciones aritméticas verificado en Coq para la validación de optimizaciones de EVM}\\ [0.3em]
}
